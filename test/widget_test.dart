...
void main() {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            classicVersesProvider(
              112,
            ).overrideWith((ref) async => [classicVerse112]),
            versesByPageProvider(
              604,
            ).overrideWith((ref) async => [classicVerse112]),
          ...
          child: MaterialApp(
            theme: AppTheme.light,
            darkTheme: AppTheme.dark,
            home: ReadingScreen(surah: classicSurah112),
          ),
        ),
      );
      await tester.pumpAndSettle();
  ...
  group('SurahTile', () {
    ...
    testWidgets('adds the English meaning in English mode', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: SurahTile(surah: classicSurah1, onTap: () => tapped = true),
          ),
        ),
      );
      expect(find.text('الفاتحة'), findsOneWidget);
  ...
  group('VerseCard', () {
    testWidgets('renders Arabic text and translation', (tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: VerseCard(verse: classicVerse1)),
        ),
      );
    ...
    testWidgets('shows bookmark icon when isBookmarked is true', (
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: VerseCard(verse: classicVerse1, isBookmarked: true),
          ),
        ),
      );
    ...
    testWidgets('hides bookmark icon when isBookmarked is false', (
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: VerseCard(verse: classicVerse1, isBookmarked: false),
          ),
        ),
      );

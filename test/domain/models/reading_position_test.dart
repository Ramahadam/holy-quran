...
void main() {
  group('ReadingPosition', () {
    ...
    test('creates instance with required fields', () {
      final position = ReadingPosition(verseId: '1:1', lastReadAt: testDate);
    ...
    test('handles different verseId formats', () {
      ...
      final position2 = ReadingPosition(verseId: '2:286', lastReadAt: testDate);
      expect(position2.verseId, '2:286');

      // Last surah
      final position3 = ReadingPosition(verseId: '114:6', lastReadAt: testDate);
    ...
    test('handles different timestamps', () {
      ...
      final position1 = ReadingPosition(verseId: '1:1', lastReadAt: now);
      final position2 = ReadingPosition(verseId: '1:2', lastReadAt: yesterday);
      final position3 = ReadingPosition(verseId: '1:3', lastReadAt: lastWeek);
    ...
    test('handles edge case verseIds', () {
      ...
      final positionEmpty = ReadingPosition(verseId: '', lastReadAt: testDate);
